...
import io.github.majianzheng.jarboot.common.utils.MathUtil;
...
public class Server {
     ...
     * 磁盘相关信息
     */
    private LinkedList<SysFile> sysFiles = new LinkedList<>();
    ...
    public void setValueTo() {
        ...
        setJvmInfo();
        // 磁盘信息
        setSysFilesInfo(systemInfo.getOperatingSystem());
    }
