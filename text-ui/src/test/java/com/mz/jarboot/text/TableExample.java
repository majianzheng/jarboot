package com.mz.jarboot.text;

import com.mz.jarboot.text.ui.BorderStyle;
...
public class TableExample {
    ...
    public void test1() {
        ...
        // 设置第二列字体加粗，加下划线
        for (int i = 0; i < 10; ++i) {
            tableElement.add(row().add(label("student" + i).style(Style.Composite.style(Color.blue).bg(Color.red)))
