...
import io.github.majianzheng.jarboot.core.cmd.model.MethodNode;
import io.github.majianzheng.jarboot.core.cmd.model.ThreadNode;
import io.github.majianzheng.jarboot.core.cmd.model.TraceNode;
import io.github.majianzheng.jarboot.core.cmd.model.ThrowNode;
...
public class TraceView implements ResultView<TraceModel> {
    ...
    @Override
    public String render(CommandSession session, TraceModel result) {
    ...
    private void recursive(int deep, boolean isLast, String prefix,
                           TraceNode node, Callback callback) {
