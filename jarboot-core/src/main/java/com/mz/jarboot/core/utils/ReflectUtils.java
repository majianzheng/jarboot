...
public class ReflectUtils {
    ...
    public static Field getField(Class<?> clazz, String name) {
        for (Field field : getFields(clazz)) {
            if (JarbootCheckUtils.isEquals(field.getName(), name)) {
                return field;
            }
        }//for
        return null;
    ...
    public static <T> T valueOf(Class<T> t, String value) {
        if (JarbootCheckUtils.isIn(t, int.class, Integer.class)) {
            return (T) Integer.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, long.class, Long.class)) {
            return (T) Long.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, double.class, Double.class)) {
            return (T) Double.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, float.class, Float.class)) {
            return (T) Float.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, char.class, Character.class)) {
            return (T) Character.valueOf(value.charAt(0));
        } else if (JarbootCheckUtils.isIn(t, byte.class, Byte.class)) {
            return (T) Byte.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, boolean.class, Boolean.class)) {
            return (T) Boolean.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, short.class, Short.class)) {
            return (T) Short.valueOf(value);
        } else if (JarbootCheckUtils.isIn(t, String.class)) {
            return (T) value;
        } else {
            return null;
        }
