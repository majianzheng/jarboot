...
public class ObjectViewTest {
    ...
    public void testNestedClass() {
        ...
        String expected = "@NestedClass[\n" +
                ...
                "        c1=@NestedClass[\n" +
                "            code=@Integer[1],\n" +
                "            c1=@NestedClass[com.mz.jarboot.core.cmd.view.ObjectViewTest$NestedClass@ffffffff],\n" +
                "            c2=@NestedClass[com.mz.jarboot.core.cmd.view.ObjectViewTest$NestedClass@ffffffff],\n" +
                "        ],\n" +
                "        c2=@NestedClass[\n" +
                "            code=@Integer[2],\n" +
                "            c1=@NestedClass[com.mz.jarboot.core.cmd.view.ObjectViewTest$NestedClass@ffffffff],\n" +
